$(document).ready(function () {
  !(function (t, e, i, n) {
    ...
    function C(t, e) {
      for (
        var i, s, r = e[0].toUpperCase() + e.slice(1), o = 0; o < dt.length;
    ...
    function j(t) {
      for (
        var e = t.srcEvent.clientX, i = t.srcEvent.clientY, n = 0; n < this.lastTouches.length; n++
      ) {
  ...
  $(".my-info-view").click(function () {
    $(".myInfo-popUp").fadeIn();
  });

  $(".observatory-view").click(function () {
    $(".observatory-popUp").fadeIn();

    showSlide(0);

    var total = $(".observatory-popUp-panel li").length;

    $(".observatory-popUp-next").on("click", function (e) {
      e.preventDefault();
    ...
    $(".observatory-popUp-prev").on("click", function (e) {
      e.preventDefault();
    ...
    $(".observatory-popUp-navi li").on("click", function (e) {
      e.preventDefault();
    ...
    function showSlide(index) {
      $(".observatory-popUp-navi li a").removeClass("on");
      $(".observatory-popUp-navi li").eq(index).children("a").addClass("on");

      $(".observatory-popUp-panel li").fadeOut().removeClass("on");
      $(".observatory-popUp-panel li").eq(index).fadeIn().addClass("on");

      currentIndex = index;
    }
  });

  $(".walkingDead-view").click(function () {
    $(".walkingDead-popUp").fadeIn();

    showSlide(0);

    var total = $(".walkingDead-popUp-panel li").length;

    $(".walkingDead-popUp-next").on("click", function (e) {
      e.preventDefault();
    ...
    $(".walkingDead-popUp-prev").on("click", function (e) {
      e.preventDefault();
    ...
    $(".walkingDead-popUp-navi li").on("click", function (e) {
      e.preventDefault();
    ...
    function showSlide(index) {
      $(".walkingDead-popUp-navi li a").removeClass("on");
      $(".walkingDead-popUp-navi li").eq(index).children("a").addClass("on");

      $(".walkingDead-popUp-panel li").fadeOut().removeClass("on");
      $(".walkingDead-popUp-panel li").eq(index).fadeIn().addClass("on");
